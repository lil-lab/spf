 ...
 * @param <LF>
 */
public interface IUpdateWeightFunction<LF> {
	...
	double evalNonOptimalParse(
			Pair<Double, ? extends IParse<LF>> nonOptimalParse);
	 ...
	 * @return
	 */
	double evalOptimalParse(Pair<Double, ? extends IParse<LF>> optimalParse);
