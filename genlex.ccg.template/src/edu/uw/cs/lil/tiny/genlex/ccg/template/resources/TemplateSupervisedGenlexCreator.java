...
public class TemplateSupervisedGenlexCreator implements
	...
	public TemplateSupervisedGenlexCreator() {
		this("genlex.template.supervised");
	}
	
	public TemplateSupervisedGenlexCreator(String type) {
		this.type = type;
	}
	...
	public ResourceUsage usage() {
		return new ResourceUsage.Builder(type(), TemplateSupervisedGenlex.class)
