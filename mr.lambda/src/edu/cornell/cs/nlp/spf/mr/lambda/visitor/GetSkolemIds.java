...
/**
 * Get all {@link SkolemId} from a logical expression.
 *
 * @author Yoav Artzi
 */
public class GetSkolemIds implements ILogicalExpressionVisitor {

	private final Set<SkolemId>	ids	= new HashSet<SkolemId>();
