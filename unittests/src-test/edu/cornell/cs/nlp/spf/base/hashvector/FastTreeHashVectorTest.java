...
public class FastTreeHashVectorTest {

	@Test
	public void test() {
		final FastTreeHashVector vector = new FastTreeHashVector();
		...
		final FastTreeHashVector pairwise = vector.pairWiseProduct(vector);
	...
	public void testSerialization() {
		...
		try {
			...
			final FastTreeHashVector object = (FastTreeHashVector) new ObjectInputStream(
