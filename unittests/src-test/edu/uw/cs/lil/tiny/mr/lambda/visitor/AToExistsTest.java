...
public class AToExistsTest {
	...
	public AToExistsTest() {
		...
		new TestServices();
		this.existsPredicate = LogicalConstant.parse("exists:<<e,t>,t>");
		this.aPredicate = LogicalConstant.parse("a:<<e,t>,e>");
		this.equalsPredicates = new HashMap<Type, LogicalConstant>();
		this.equalsPredicates.put(LogicLanguageServices.getTypeRepository()
				.getEntityType(), LogicalConstant.parse("eq:<e,<e,t>>"));
	...
	public void test2() {
		final LogicalExpression exp = LogicalExpression
				.parse("(lambda $0:e (to:<e,<e,t>> $0 (a:<<e,t>,e> (lambda $1:e (and:<t*,t> (chair:<e,t> $1) (intersect:<e,<e,t>> $1 (a:<<e,t>,e> (lambda $2:e (corner:<e,t> $2)))))))))");
		final LogicalExpression result = LogicalExpression
	...
	public void test3() {
		final LogicalExpression exp = LogicalExpression
				.parse("(intersect:<e,<e,t>> (a:<<e,t>,e> (lambda $0:e (chair:<e,t> $0))) (a:<<e,t>,e> (lambda $1:e (corner:<e,t> $1))))");
		final LogicalExpression result = LogicalExpression
	...
	public void test5() {
		...
		final LogicalExpression result = LogicalExpression
				.parse("(exists:<<e,t>,t> (lambda $0:e (intersection:<e,t> $0)))");
		final LogicalExpression out = AToExists.of(exp, existsPredicate,
				aPredicate, equalsPredicates);
		Assert.assertEquals(result, out);
	}
