...
public class SituatedValidationStocGradCreator<STATE, MR, ESTEP, ERESULT>
		implements
		IResourceObjectCreator<SituatedValidationStocGrad<STATE, MR, ESTEP, ERESULT>> {
	...
	@Override
	public SituatedValidationStocGrad<STATE, MR, ESTEP, ERESULT> create(
		...
		final Builder<STATE, MR, ESTEP, ERESULT> builder = new SituatedValidationStocGrad.Builder<STATE, MR, ESTEP, ERESULT>(
				trainingData,
				(IJointGraphParser<Sentence, STATE, MR, ESTEP, ERESULT>) repo
						.getResource(ParameterizedExperiment.PARSER_RESOURCE),
				(IValidator<IDataItem<Pair<Sentence, STATE>>, ERESULT>) repo
