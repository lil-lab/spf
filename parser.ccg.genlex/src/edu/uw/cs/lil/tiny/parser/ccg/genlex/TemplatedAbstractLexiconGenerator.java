 ...
 * @author Yoav Artzi
 */
public class TemplatedAbstractLexiconGenerator implements
		ILexiconGenerator<Sentence, LogicalExpression> {
	private static final ILogger								LOG	= LoggerFactory
																			.create(TemplatedAbstractLexiconGenerator.class);
	...
	protected TemplatedAbstractLexiconGenerator(Set<LexicalTemplate> templates,
	...
	public ILexicon<LogicalExpression> generate(Sentence dataItem) {
		...
		int counter = 0;
		for (final IParseResult<LogicalExpression> parse : parserOutput
				.getAllParses()) {
	...
	public static class Builder {
		...
		public TemplatedAbstractLexiconGenerator build() {
			return new TemplatedAbstractLexiconGenerator(templates,
