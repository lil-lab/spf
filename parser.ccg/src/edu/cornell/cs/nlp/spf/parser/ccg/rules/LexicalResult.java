...
/**
 * The result of applying {@link ILexicalRule}.
 * 
 * @author Yoav Artzi
 * @param <MR>
...
public class LexicalResult<MR> extends ParseRuleResult<MR> {
	...
	public LexicalResult(RuleName ruleName, Category<MR> resultCategory,
			LexicalEntry<MR> entry) {
		super(ruleName, resultCategory);
		this.entry = entry;
	}
